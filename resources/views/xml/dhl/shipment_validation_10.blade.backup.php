...
<req:ShipmentRequest xmlns:req="http://www.dhl.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.dhl.com ship-val-global-req.xsd" schemaVersion="10.0">
	...
	<Consignee>
		...
		@if($order->DAddress2)<AddressLine2>{{$order->DAddress2}}</AddressLine2>@endif
	...
	<Shipper>
		...
		@if($vars['shipper']->Address2)<AddressLine2>{{ $vars['shipper']->Address2 }}</AddressLine2>@endif
		@if($vars['shipper']->Address3)<AddressLine3>{{ $vars['shipper']->Address3 }}</AddressLine3>@endif
